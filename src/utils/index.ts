import { AGENT_NODE_DRAG_HANDLE, START_NODE_DRAG_HANDLE, NODE_TYPE, END_NODE_DRAG_HANDLE, CONDITION_NODE_DRAG_HANDLE, ANNOTATION_DRAG_HANDLE } from "../pages/createWorkFlow/constants";
...
const getDrageHandle = (type: NODE_TYPE) => {
    switch(type) {
...
export { getUserInfo, getAppInfo, getDrageHandle };
